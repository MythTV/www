...
<ul>
  ...
  <ul>
    <li>Renchi Raju's essentially rewritten the MythNews and MythGallery plugins -- check out the <a href="/detail/mythtv">features section</a> for some updated images.  Not pictured are the rather neat slideshow transitions he's added (and is still adding).  Some are opengl based, some not.  Very slick.
