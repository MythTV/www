...
<p>So let me repeat, if you upgrade to MythTV 0.27.4 you will continue to use Schedules Direct with no further action required on your behalf. Do not use any of the other unofficial solutions such as the 'JSON' grabber from Schedules Direct. Actions may be taken in future to actively block the use of this 'JSON' grabber because of the damage it may cause to the integrity of the MythTV database.</p>
