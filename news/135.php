<?php
    $topic  = 'announcement';
    $title  = '0.23 Release Candidate 2 Available';
    $author = 'robertm';
    $date   = strtotime('2010-04-01 20:27:52 UTC');
?>
<ul>
    <li>The second Release Candidate for MythTV 0.23 is now available.
        </li>
    <li>Important changes since the last RC include:
        <ul>
            <li>Several crash fixes
                </li>
            <li>Many new and updated translations                                                         
                </li>
            <li>Fix seeking in some recorders in LiveTV                                                         
                </li>
            <li>Theme fixes                                                         
                </li>
        </ul></li>
