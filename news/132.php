...
interface and today we're announcing a
<a href="/theming_competition.html">competition</a>
to design new themes for MythTV.
    ...
    <li>You can <a href="ftp://ftp.osuosl.org/pub/mythtv/">download the tarballs</a> now:
        <ul>
            <li><a href="ftp://ftp.osuosl.org/pub/mythtv/mythtv-0.22.tar.bz2">MythTV</a>
                (<a href="http://svn.mythtv.org/svn/trunk/checksums/mythtv-0.22.md5sum">MD5</a>)
                </li>
            <li><a 
href="ftp://ftp.osuosl.org/pub/mythtv/mythplugins-0.22.tar.bz2">MythPlugins</a>
                (<a 
href="http://svn.mythtv.org/svn/trunk/checksums/mythplugins-0.22.md5sum">MD5</a>)
                </li>
            <li><a href="ftp://ftp.osuosl.org/pub/mythtv/myththemes-0.22.tar.bz2">MythThemes</a>
                (<a 
