<?php
    $topic  = 'announcement';
    $title  = 'IRC Network Change';
    $author = 'stuarta';
    $date   = strtotime('2021-06-16 18:40:53 UTC');
?>
...
<p>A quick recap of our main channels
    <ul>
        <li>#mythtv-users, The main user support channel</li>
        <li>#mythtv, The main development channel</li>
    </ul>
<p>
