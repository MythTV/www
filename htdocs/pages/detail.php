...
<?php tv_thumb('mythweb_listing.png', 'tv_grey', 'r', 'a')  ?>
<?php tv_thumb('mythweb_details.png', 'tv_grey', 'l', 'a')  ?>
</div>
...
<?php tv_thumb('mythweb_upcoming.png', 'tv_grey', 'r', 'a')  ?>
<?php tv_thumb('mythweb_recorded.png', 'tv_grey', 'l', 'a')  ?>
</div>
