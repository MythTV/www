...
<div id="contact" class="inset">
    ...
    <div class="content">
        ...
        through normal community support channels.
        </p>
        ...
        <a href="/support">support inquiries</a>, or other similar
        queries that are more appropriately answered by using the
        correct community tools.
        </p>
