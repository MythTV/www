...
?>
<ul>
    <li>Hey all, just wanted to make sure everyone saw that
        <a href="http://www.schedulesdirect.org">Schedules Direct</a> is now out
        of beta testing and fully open for anyone who wants to sign up.
        </li>
    <li>With the release of 0.20.2 the other day, switching your Myth config over
        from using Zap2It labs for data is fairly easy.  Please see
        <a href="http://www.mythtv.org/pipermail/mythtv-users/2007-August/191369.html">this
        mailing list posting from Bruce</a> for a short set of instructions - but
    ...
    <li>I know, it's a bit hard to start paying for guide data.  It was free for
    ...
    <li>If you're on the fence about signing up due to feeling that the price
    ...
    <li>And finally, I'd like to thank everyone who has already become a member
        of SD - your support of this project is great. =)  And if you haven't,
        please <a href="http://www.schedulesdirect.org"> consider becoming a
        member of Schedules Direct</a>.  Thanks.
        </li>
</ul>
