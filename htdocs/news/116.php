<?php
    ...
    $title  = '0.19';
    $author = 'isaac';
    $date   = strtotime('2006-02-12 01:16:19 UTC');
?>
<ul>
  <li>Good morning.  After many months, we have a new release of MythTV for you.  Because, you know, we like you.  Kind of.  Anyway.
  <li>The <a href="http://www.mythtv.org/wiki/index.php/Release_Notes_-_0.19">Release notes page in the wiki</a> has a great list of what's new and changed.
  ...
  <ul>
    ...
    <li>The <a href="http://www.mythtv.org/wiki/index.php/Packages">binary packages</a> should hopefully be updated to 0.19 soon.
